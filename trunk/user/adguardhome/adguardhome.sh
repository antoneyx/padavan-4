...
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://ghproxy.com/https://raw.githubusercontent.com/antoneyx/padavan-4/main/trunk/user/adguardhome/AdGuardHome
